...
public class Estudiante {
 ...
 public static void insertarEstudiante(Estudiante estudiante) {
    ...
    String sql = "INSERT INTO estudiante (id_estudiante, nombre, edad) VALUES (?, ?, ?)";
  ...
  public static List<Estudiante> obtenerTodosLosEstudiantes() {
    ...
    String sql = "SELECT id_estudiante, nombre, edad FROM estudiante";
    ...
    try {
      ...
      while (resultSet.next()) {
        ...
        Estudiante estudiante = new Estudiante(id_estudiante,nombre, edad);
